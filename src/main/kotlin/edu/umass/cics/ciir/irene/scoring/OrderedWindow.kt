...
class OrderedWindow(val stats: LazyCountStats, override val children: List<LeafEvalNode>, val step: Int) : AndEval<LeafEvalNode>(), CountEvalNode {
    init {
    ...
    override fun score(doc: Int): Float = error("notImpl")
